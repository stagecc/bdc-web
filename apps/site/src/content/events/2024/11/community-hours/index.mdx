...
materials:
  - type: forum
    url: https://bdcatalyst.freshdesk.com/support/discussions/topics/60000407894
...
All users are invited to attend, whether you are new to BDC or have been using it for some time. If you are not yet registered for the ecosystem, we welcome you to [join our community](/stay-connected/).
