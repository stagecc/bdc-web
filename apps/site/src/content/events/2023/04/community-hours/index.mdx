...
materials:
  - type: forum
    url: https://bdcatalyst.freshdesk.com/support/discussions/topics/60000407425
...
All users are invited to attend, whether you are new to BDC or have been using it for some time. If you are not yet registered for the ecosystem, we welcome you to [join our community](/stay-connected/). If you cannot attend on this date, you can still sign up and the recording and slides will be sent to you.
