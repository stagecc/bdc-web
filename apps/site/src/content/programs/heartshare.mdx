---
excerpt: >
  HeartShare data in BDC includes phenotypic, imaging, and omics data from people with heart failure with preserved ejection fraction (HFpEF) and controls, including baseline and longitudinal data.
---
