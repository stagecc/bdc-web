...
seo:
  title: Increasing Data Security Can Also Improve Usability
excerpt: >
  Deploying security controls in biomedical data ecosystems is not usually known for improving 
  usability, but sometimes, making data more secure also means making it easier to use. The most 
  recent example is BDC's implementation of the NIH Researcher Auth Service (RAS).
---
