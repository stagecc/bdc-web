...
seo:
  title: NHLBI BioData Catalyst® named as a 2023 GA4GH Driver Project
excerpt: >
  The Global Alliance for Genomics and Health (GA4GH) announced on September 20, 2023, 
  that NHLBI BioData Catalyst (BDC) was named one of seven new 2023 GA4GH Driver Projects. 
  Three more projects are expected to join in the coming weeks.
---

import Figure from '@components/news/Figure.astro'
import meeting from './ga4gh-11th-plenary-meeting.jpg'
import logo from './ga4gh-driver-project-logo.png';
...
<Figure
  src={meeting}
  alt="An individual standing behind a lectern addresses a large audience at a conference"
  caption="BDC was named as a GA4GH Driver Project during the GA4GH 11th Plenary meeting in San Francisco. Pictured is GA4GH CEO Peter Goodhand making the announcement. Photo Credit: Jaclyn Ryan"
  float="right"
  width="normal"
/>
...
<Figure
  src={logo}
  alt="GA4GH Driver Project Badge"
  float="left"
  width="small"
/>
